        ...
        <div className="row justify-content-center">
            <div className="col-12">
                <div className="section-title text-center mb-4 pb-2">
                    ...
                    <p className="text-muted para-desc mx-auto mb-0">Chcesz przejść na zieloną energię i zacząć oszczędzać? Skontaktuj się z nami i dowiedz się, jak możemy pomóc w instalacji fotowoltaiki, pomp ciepła i innych rozwiązań OZE. Oferujemy kompleksową pomoc przy uzyskaniu dotacji z programów takich jak "Mój Prąd" i "Czyste Powietrze".</p>
                </div>
            </div>
        </div>
