                ...
                <div className="container">
                    ...
                    <div className="row justify-content-center">
                        <div className="col-sm-8 mt-4 mt-sm-0">
                            <div className="text-center">
                                <p className="mb-0 text-foot accent">© {new Date().getFullYear()} Komplex System. Wszelkie
                                    prawa zastrzeżone. <Link href="/polityka-prywatnosci" className="text-foot accent underline">Polityka Prywatności</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
